...
JNIEnv* ZCouchbaseManager::CreateVM(JavaVM** jvm)
	...
	options[0].optionString = (char*)"-Djava.class.path=./couchbase/java/lib/commons-logging-1.1.3.jar:./couchbase/java/lib/couchbase-lite-java-1.1.0.jar:./couchbase/java/lib/couchbase-lite-java-core.jar:./couchbase/java/lib/couchbase-lite-java-core-1.1.0.jar:./couchbase/java/lib/couchbase-lite-java-native.jar:./couchbase/java/lib/couchbase-lite-java-native-1.1.0.jar:./couchbase/java/lib/couchbase-lite-java-native-sources.jar:./couchbase/java/lib/doclet.jar:./couchbase/java/lib/httpclient-4.0-beta1.jar:./couchbase/java/lib/httpcore-4.0-beta2.jar:./couchbase/java/lib/jackson-annotations-2.5.0.jar:./couchbase/java/lib/jackson-core-2.5.0.jar:./couchbase/java/lib/jackson-databind-2.5.0.jar:./couchbase/java/lib/stateless4j-2.4.0.jar:./couchbase/java/classes";
